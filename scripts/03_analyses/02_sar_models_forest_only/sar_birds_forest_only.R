...
sesvert.t = sesvert.t %>% 
  dplyr::select(!c(clim_velocity, elev, precip_sea, precip_dry, log_precip_wet))
...
# SES model
f = formula(vert.mean.ses ~ log_elev + log_clim_velocity + tmax_warm + tmin_cold + log_precip_dry + log_precip_sea + precip_wet + veg_complexity)
...
save(sesvert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, sesvert.dredge, sesvert.avg, file = "results/sar_mods_forest_only/birds/birdselton_sar_sesvert2.RData")
...
env.future.df = sesvert.scale %>% 
  ...
  dplyr::select(x,y, tmax_warm, tmin_cold, precip_wet, log_precip_dry, log_precip_sea, log_elev, veg_complexity, log_clim_velocity)
...
save(sesvert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, sesvert.dredge, best_mods_pred, file = "results/sar_mods_forest_only/birds/birdselton_sar_sesvert2.RData")
load("results/sar_mods_forest_only/birds/birdselton_sar_sesvert2.RData")
...
save(sesvert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, sesvert.dredge, sesvert.avg, best_mods_pred, 
     sesvert.scale.sub, file = "results/sar_mods_forest_only/birds/birdselton_sar_sesvert2.RData")
load("results/sar_mods_forest_only/birds/birdselton_sar_sesvert2.RData")
...
# vert mean model
f = formula(vert.mean ~ log_elev + log_clim_velocity + precip_dry + log_precip_sea + precip_wet + tmax_warm + tmin_cold + veg_complexity)
...
save(vert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, vert.dredge, file = "results/sar_mods_forest_only/birds/birdselton_sar_vertmean.RData")
...
save(vert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, vert.dredge, vert.avg, best_mods_pred, file = "results/sar_mods_forest_only/birds/birdselton_sar_vertmean.RData")
...
save(vert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, vert.dredge, vert.avg,
     best_mods_pred, vert.scale.sub, file = "results/sar_mods_forest_only/birds/birdselton_sar_vertmean.RData")
