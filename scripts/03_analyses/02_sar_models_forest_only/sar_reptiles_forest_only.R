...
save(sesvert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, sesvert.dredge,
     sesvert.avg, file = "results/sar_mods_forest_only/reptiles/reptiles_sar_sesvert2.RData")
...
save(sesvert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, sesvert.dredge, 
     sesvert.avg, best_mods_pred, sesvert.scale.sub, file = "results/sar_mods_forest_only/reptiles/reptiles_sar_sesvert2.RData")
...
save(vert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, vert.dredge, 
     vert.avg, best_mods_pred, file = "results/sar_mods_forest_only/reptiles/reptiles_sar_vertmean2.RData")
...
save(vert.full, wts.rs, wts.idist, wts.idist2, mod.rs, mod.idist, mod.idist2, vert.dredge, 
     vert.avg, best_mods_pred, vert.scale.sub, file = "results/sar_mods_forest_only/reptiles/reptiles_sar_vertmean2.RData")
