...
cor.test(dat$canopy_height2, dat$fhd)
...
vif(lm(vert.mean.ses ~ canopy_height2 + veg_den +  I(tmax_warm^2) + tmax_warm + temp_diu +
...
saveRDS(list(mesh = mesh), "results/sdmTMB_models2.3/birds_sesvert_tempdiu.rds")
out = readRDS("results/sdmTMB_models2.3/birds_sesvert_tempdiu.rds")
mesh = out$mesh

taxon = "Birds"
response_var = "SES verticality"
fname_end = "birds_sesvert"
...
saveRDS(list(mesh = mesh, fullmod = fullmod), "results/sdmTMB_models2.3/birds_sesvert_tempdiu.rds")



plot_resids(mod = fullmod, response_var = "vert.mean.ses", 
            fpath = paste0("figures/residual_checks/sdmTMB2.3/birds_tempdiu/",fname_end), integer_response = F)
...
# 
# mesh = fitmesh$meshes[[length(fitmesh$meshes)]]
# saveRDS(list(mesh = mesh), "results/sdmTMB_models2.3/birds_sesvert.rds")
# out = readRDS("results/sdmTMB_models2.3/birds_sesvert.rds")
# mesh = out$mesh
...
# 
# saveRDS(list(mesh = mesh, compMods_aic = compMods_aic),  "results/sdmTMB_models2.3/birds_sesvert.rds")
# out = readRDS("results/sdmTMB_models2.3/birds_sesvert.rds")
# 
# # refit best model with REML estimation
# compMods_aic = out$compMods_aic
# compMods_aic$modsel
# sanity(compMods_aic$modlist[[6]])
# summary(compMods_aic$modlist[[6]])
# 
# # refit model using REML
# bestmod = compareMods_AIC(f = list(forms[[6]]), dat, mesh, taxon = taxon, response_var = response_var, family = gaussian(), reml = T)
# bestmod = bestmod$modlist[[1]]
# #bestmod = run_extra_optimization(bestmod)
# saveRDS(list(mesh = mesh, compMods_aic = compMods_aic, bestmod = bestmod), "results/sdmTMB_models2.3/birds_sesvert.rds")
# 
...
plot_resids(mod = bestmod, response_var = "vert.mean.ses", 
            fpath = paste0("figures/residual_checks/sdmTMB2.3/birds/",fname_end), integer_response = F)
...
# 
# mesh = fitmesh$meshes[[length(fitmesh$meshes)]]
# saveRDS(list(mesh = mesh), "results/sdmTMB_models2.3/birds_sesvert_tempsea.rds")
# out = readRDS("results/sdmTMB_models2.3/birds_sesvert_tempsea.rds")
# mesh = out$mesh
# 
# taxon = "Birds"
# response_var = "SES verticality"
...
# compMods_aic = compareMods_AIC(f = forms, dat, mesh, taxon = taxon, response_var = response_var, family = gaussian(), reml = F)
# 
# saveRDS(list(mesh = mesh, compMods_aic = compMods_aic),  "results/sdmTMB_models2.3/birds_sesvert_tempsea.rds")
# out = readRDS("results/sdmTMB_models2.3/birds_sesvert_tempsea.rds")
# 
# # refit best model with REML estimation
# compMods_aic = out$compMods_aic
...
# out1 = readRDS("results/sdmTMB_models2.3/birds_sesvert.rds")
...
# bestmod = bestmod$modlist[[1]]
# #bestmod = run_extra_optimization(bestmod)
# saveRDS(list(mesh = mesh, compMods_aic = compMods_aic, bestmod = bestmod), "results/sdmTMB_models2.3/birds_sesvert_tempsea.rds")
# 
# # * - residual check ----------------------------------------------------------
# 
# out = readRDS("results/sdmTMB_models2.3/birds_sesvert_tempsea.rds")
...
# 
# plot_resids(mod = bestmod, response_var = "vert.mean.ses", 
#             fpath = paste0("figures/residual_checks/sdmTMB2.3/birds_tempsea/",fname_end), integer_response = F)
# 
# 
# 
# 
