...
amph.sesvert.dif.plt = plt_rast_margin(r = amph.pdat, v = wd, margin.title = "avg. relative\ndifference by latitude",
...
rept.sesvert.dif.plt = plt_rast_margin(r = rept.pdat, v = wd, margin.title = "avg. relative\ndifference by latitude",
...
mammals.sesvert.dif.plt = plt_rast_margin(r = mammals.pdat, v = wd, margin.title = "avg. relative\ndifference by latitude",
...
birds.sesvert.dif.plt = plt_rast_margin(r = birds.pdat, v = wd, margin.title = "avg. relative\ndifference by latitude",
